...
| `invitationLink` | Unique acceptance link        | "https://app.insohq.com/invite/abc123" |
...
mailgun: {
  ...
  mailgun_from: process.env.MAILGUN_FROM || 'noreply@insohq.com'
}
```
...
```javascript
app: {
  frontend_url: process.env.FRONTEND_URL || 'https://app.insohq.com';
}
```
