...
| `invitationLink` | Unique acceptance link        | "https://app.insoai.com/invite/abc123" |
...
mailgun: {
  ...
  mailgun_from: process.env.MAILGUN_FROM || 'noreply@insoai.com'
}
```
...
```javascript
app: {
  frontend_url: process.env.FRONTEND_URL || 'https://app.insoai.com';
}
```
