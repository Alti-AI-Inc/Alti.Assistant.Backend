...
```json
{
  ...
  "data": {
    ...
    "gcsUrl": "https://storage.googleapis.com/inso_knowledge_bank_files/users/USER_ID/1699876543210_document.pdf",
...
GCS_KNOWLEDGEBOT_BUCKET=inso_assistant_knowledge_bot_files
```

### GCS Bucket Setup

1. Create a bucket named `inso_knowledge_bank_files` in Google Cloud Storage
