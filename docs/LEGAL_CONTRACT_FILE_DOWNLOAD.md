...
1. **GCS Upload Service** (`services/gcsUploadService.js`)
   ...
   - Uploads contract files to GCS bucket: `insoai_assistant_documents`
...
```bash
GCS_BUCKET_NAME=insoai_assistant_documents
...
Download Link: https://storage.googleapis.com/insoai_assistant_documents/contract/user123/employment_1735500000.txt
