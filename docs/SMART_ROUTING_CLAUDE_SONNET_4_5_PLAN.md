...
export function isCodeRelatedQuery(query) {
  ...
  const languages = ['javascript', 'python', 'java', 'c++', 'typescript', 'go', 'rust', 'php', 'ruby', 'swift', 'kotlin', 'c#'];
  
  // Code keywords
  const codeKeywords = ['function', 'class', 'method', 'code', 'algorithm', 'debug', 'error', 'bug', 'implement', 'refactor'];
  
  // Technical terms
  const techKeywords = ['api', 'database', 'framework', 'library', 'package', 'npm', 'git', 'docker', 'deploy'];
