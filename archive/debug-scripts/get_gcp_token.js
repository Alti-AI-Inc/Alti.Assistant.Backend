...
async function main() {
  ...
  // Calculate skew:
  // Let's fetch the network time to compute the exact skew relative to local time.
  ...
  try {
    ...
    // Save token to file in parent directory so both parent and backend can access it
