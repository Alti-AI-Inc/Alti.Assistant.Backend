...
3. **Data Residency**: Supports regulatory compliance by pinning ingestion pipelines and document index storages to specific regional buckets [Source #2].`;
            ...
            content = `Hello! I am Alti Assistant, your premium RAG-enabled digital assistant. How can I help you explore your enterprise knowledge base or coordinate active automation today?`;
          }
        }
...
async function conversationalNode(state) {
  ...
  const systemPrompt = `You are Alti Assistant, a premium, helpful, and highly intelligent AI assistant. 
