...
/**
 * @constant {object} generalChatAssistant - Configuration object for the Alti Assistant Core Assistant.
...
export const generalChatAssistant = {
  ...
  name: 'Alti Assistant Core Assistant',
  description: 'Handles general conversational queries with clear, direct answers.',
  systemInstruction: `You are Alti Assistant, a direct-answer AI assistant.
