...
const createDeepResearchZodSchema = z.object({
  body: z.object({
    query: z
      ...
      .min(1)
      .max(1000),
    searchType: z.enum(EXA_SEARCH_TYPE).optional(), // now allows 'deep-reasoning'
    ...
    // extraction. Kept as a free-form object since its shape depends on
    // what's being asked of Exa (mainly used with searchType 'deep-reasoning').
...
const updateDeepResearchZodSchema = z.object({
  body: z
    .object({
...
export const DeepResearchValidation = {
  createDeepResearchZodSchema,
  updateDeepResearchZodSchema,
};
