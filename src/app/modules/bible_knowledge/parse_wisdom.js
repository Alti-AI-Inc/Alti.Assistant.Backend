...
async function buildDatabase() {
    ...
    // Tier 3 Secret Guardrail Additions
    database.push({ book: 'The Shepherd of Hermas', chapter: 1, verse: 1, text: 'There are two angels with a man—one of righteousness, and the other of iniquity. The angel of righteousness is mild and modest, and gentle and quiet. When therefore, he ascends into your heart, immediately he talks to you of righteousness, of purity, of chastity, and of piety. But the angel of iniquity is bitter, and ill-tempered, and wrathful.'});
    database.push({ book: 'The Celestial Hierarchy', chapter: 1, verse: 1, text: 'Every good endowment and every perfect gift is from above, coming down from the Father of Lights. For the Uncreated Light of the Divine shines forth, illuminating the heavenly hierarchies in perfect order, leading all things back to unity.'});
    database.push({ book: 'On the Incarnation', chapter: 1, verse: 1, text: 'The Word of God, incorporeal, incorruptible, and immaterial, entered our world. Not that He was far from it before, for no part of creation is left void of Him: He has filled all things everywhere.'});
    database.push({ book: 'Against Heresies', chapter: 1, verse: 1, text: 'Error, indeed, is never set forth in its naked deformity, lest, being thus exposed, it should at once be detected. But it is craftily decked out in an attractive dress, so as, by its outward form, to make it appear to the inexperienced more true than the truth itself.'});
