...
export const RESPONSE_MESSAGES = {
  QUESTIONS_GENERATED: 'I need to ask you a few essential questions to create a proper legal contract. Please provide answers to help me draft the contract accurately.',
  CONTRACT_GENERATED: 'I have generated your legal contract based on the information provided. Please review it carefully. This is a draft and should be reviewed by a qualified attorney before use.',
  FILE_PROCESSED: 'I have reviewed the uploaded document. Now, let me ask a few questions to create the contract.',
  INSUFFICIENT_INFO: 'I need more information to create a comprehensive contract. Please answer the questions above.',
  ERROR_GENERATING: 'I encountered an error while generating the contract. Please try again or provide more details.',
  FILE_REQUIRED: 'Please upload any relevant documents or provide detailed information about the contract you need.',
  CLARIFICATION_NEEDED: 'I need clarification on some points before generating the contract.',
