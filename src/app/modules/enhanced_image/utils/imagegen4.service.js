 ...
 * @description The absolute path to the GCP service account key file (`inso_gcp.json`), resolved from the current working directory.
 * @private
 */
 ...
 * @description An instance of the GCPStorageService, configured for the 'inso_assistant_generated_photo' bucket.
