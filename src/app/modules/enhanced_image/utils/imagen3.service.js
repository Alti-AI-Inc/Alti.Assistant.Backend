...
const gcpKeyPath = path.join(process.cwd(), 'inso_gcp.json');

/**
 * An instance of the GCPStorageService configured for the 'inso_assistant_generated_photo' bucket.
...
const gcpStorage = new GCPStorageService(
  'inso_assistant_generated_photo',
  gcpKeyPath
);
