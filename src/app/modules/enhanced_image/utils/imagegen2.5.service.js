 ...
 * Pulled from application configuration.
 */
const GCP_BUCKET_NAME = config.gcp.storage_bucket_name || 'insoai_assistant_generated_photo';
 ...
 * Pulled from application configuration.
 */
const GCP_KEY_PATH = config.gcp.key_file_path || path.join(process.cwd(), 'insoai_gcp.json');
