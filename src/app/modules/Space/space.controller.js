...
const createSpace = catchAsync(async (req, res) =>
  respond(
    ...
    await SpaceService.createSpace(req.body, userId(req))
  )
);
const getAllSpaces = catchAsync(async (req, res) => {
  const result = await SpaceService.getAllSpaces(userId(req), req.query);
  respond(
    res,
    httpStatus.OK,
...
const getSingleSpace = catchAsync(async (req, res) =>
  respond(
    ...
    await SpaceService.getSingleSpace(req.params.id, userId(req))
  )
);
const updateSpace = catchAsync(async (req, res) =>
  respond(
    ...
    await SpaceService.updateSpace(req.params.id, userId(req), req.body)
  )
);
const addMember = catchAsync(async (req, res) =>
  respond(
    ...
    await SpaceService.addMember(req.params.id, userId(req), req.body)
  )
);
...
const deleteSpace = catchAsync(async (req, res) =>
  respond(
    ...
    await SpaceService.deleteSpace(req.params.id, userId(req))
  )
);
