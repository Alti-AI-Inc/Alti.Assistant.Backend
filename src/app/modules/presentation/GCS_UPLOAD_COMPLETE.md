...
✅ **Upload presentations to GCS bucket "insoai_assistant_presentation"**
...
Download File from Presenton URL
    ↓
Upload to GCS (insoai_assistant_presentation bucket)
    ↓
Make File Public
    ↓
Get Public URL
...
```
gs://insoai_assistant_presentation/
  ├── {userId}/
  │   └── {conversationId}/
...
```json
{
  ...
  "publicUrl": "https://storage.googleapis.com/insoai_assistant_presentation/.../presentation.pptx",
  "creditsConsumed": 10
}
```
...
# Optional - defaults to 'insoai_assistant_presentation'
...
✅ Upload to insoai_assistant_presentation bucket
✅ Save public URL to conversation model
✅ Send URL in response
