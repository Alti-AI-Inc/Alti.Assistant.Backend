...
The module uses the `insoai_assistant_presentation` bucket (configurable via `GCS_PRESENTATION_BUCKET` env var).
...
```json
{
  ...
  "publicUrl": "https://storage.googleapis.com/insoai_assistant_presentation/user123/conv456/presentation_abc123.pptx",
  "creditsConsumed": 10
}
```
...
```javascript
{
  metadata: {
    // ... other metadata
    presentationUrl: "https://storage.googleapis.com/insoai_assistant_presentation/.../presentation.pptx",
