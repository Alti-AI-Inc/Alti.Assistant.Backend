 ...
 * @property {string} name - A unique name for the data source (e.g., 'inso-default-postgres').
 ...
 *
 * @param {string} toolsetName - The registered toolset or source name to target (e.g., 'inso-default-postgres').
...
const queryNaturalLanguage = async (queryText, databaseContext = {}) => {
  ...
  try {
    ...
    const mcpResult = await executeMcpTool('inso-default-postgres', 'execute_sql', {
