 ...
 * @param {string} [serviceName] - Microservice identifier (default 'insoai-backend')
 * @returns {Promise<object>} An object indicating the outcome of the queueing operation.
 */
const reportError = async (errorMessage, stackTrace = '', user = '', serviceName = 'insoai-backend') => {
  try {
