...
describe('gcsUploadService', () => {
  ...
  describe('uploadReportToGCS', () => {
    ...
    it('should successfully upload an absolute path file to GCS and return upload details', async () => {
      ...
      expect(mockBucket).toHaveBeenCalledWith('insoai_assistant_reports');
      ...
      expect(result).toEqual({
        success: true,
        publicUrl: `https://storage.googleapis.com/insoai_assistant_reports/${userId}/${conversationId}/${fileName}`,
        gcsPath: `${userId}/${conversationId}/${fileName}`,
        bucket: 'insoai_assistant_reports',
