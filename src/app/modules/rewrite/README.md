...
```json
{
  ...
  "data": {
    ...
    "file": {
      ...
      "path": "gs://insoai_files/rewrites/user123/rewritten_1234567890_document.txt",
      "publicUrl": "https://storage.googleapis.com/insoai_files/rewrites/...",
      "size": 1024,
      "storageType": "gcs"
    },
    "outputFormat": "both"
...
- **Bucket Name**: `insoai_files` (configurable via `GCS_BUCKET_NAME` environment variable)
