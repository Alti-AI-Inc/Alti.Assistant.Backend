  ...
  describe('asyncExtractFacts', () => {
    ...
    it('should process upserts and deletes correctly based on Gemini response', async () => {
      ...
      const geminiResponse = [
        ...
        { key: 'company', value: 'Inso Assistantorem', category: 'facts', action: 'upsert' },
      ...
      userMemoryService.asyncExtractFacts(userId, 'I moved to Munich and work at Inso Assistantorem', 'Got it.');
      ...
      expect(UserMemory.bulkWrite).toHaveBeenCalledWith([
        ...
        },
        {
          updateOne: {
            ...
            update: { $set: { value: 'Inso Assistantorem', category: 'facts', confidence: 1.0 } },
            upsert: true,
          },
        },
      ]);
