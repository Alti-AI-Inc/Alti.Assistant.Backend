...
export async function executeSmartSearch(
  ...
  if (sportsClass.isSports) {
    ...
    if (forceReAct) {
      ...
      try {
        const messages = [
          { role: 'system', content: 'You are Inso Assistant, an expert sports betting AI. Use the predictiondata-sports-odds tool for all real-time odds, player props, SGP pricing, and prediction market queries.' },
          ...conversationHistory,
