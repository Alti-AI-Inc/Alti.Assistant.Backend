...
class TemporalWorkerCoordinator {
  ...
  /**
   * Initializes and starts the background Temporal Worker polling inso-workflows-queue
   */
  async start() {
    ...
    try {
      ...
      logger.info('[Temporal Worker] Resilient Temporal Worker successfully started and polling: "inso-workflows-queue".');
    } catch (error) {
