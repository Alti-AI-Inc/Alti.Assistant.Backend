...
Your translation module is now fully configured and ready to use with your existing Google Cloud credentials (`inso_gcp.json`).
...
✅ Google Cloud credentials configured (inso_gcp.json)
...
- Select project: `inso-assistant-prod`
