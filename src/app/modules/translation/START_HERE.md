...
Your translation module is now fully configured and ready to use with your existing Google Cloud credentials (`insoai_gcp.json`).
...
✅ Google Cloud credentials configured (insoai_gcp.json)
...
- Select project: `insoai-assistant-prod`
