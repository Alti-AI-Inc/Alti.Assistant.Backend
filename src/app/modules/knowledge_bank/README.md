...
| **GCS Bucket**   | `insoai_knowledge_bank_files`     | `insoai_assistant_knowledge_bot_files`        |
...
1. Create a GCS bucket named `insoai_knowledge_bank_files`
2. Configure IAM permissions for the service account
3. Ensure the service account JSON key file (`insoai_gcp.json`) is in the project root
