 ...
 * and is associated with a specific workspace.
 */
...
// Compound index to help worker processes efficiently find pending or failed jobs to process/retry.
// Sorts by creation time to process older jobs first (FIFO).
DatasetQueueSchema.index({ status: 1, createdAt: 1 });
