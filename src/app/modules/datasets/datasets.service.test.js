...
vi.mock('../../../../config/index.js', () => ({
  default: {
    ...
    gcs: {
      knowledge_bank_bucket: 'mock-inso-assistant-datasets',
...
describe('DatasetsService', () => {
  ...
  describe('archiveDatasetToGCSCore', () => {
    ...
    it('should successfully archive dataset to GCS', async () => {
      ...
      expect(mockDatasetInstance.gcsBucket).toBe('mock-inso-assistant-datasets');
      expect(mockDatasetInstance.gcsPaths).toEqual(['gs://mock-inso-assistant-datasets/datasets/mock/dataset/default/train/file1.parquet']);
    ...
    it('should create bucket if it does not exist', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('GCS Bucket "mock-inso-assistant-datasets" does not exist. Attempting to create...'));
      expect(mockDatasetInstance.status).toBe('archived');
    });
  ...
  describe('indexDatasetForRAGCore', () => {
    ...
    it('should successfully index dataset from GCS', async () => {
      ...
      const dataset = {
        ...mockDatasetInstance,
        status: 'archived',
        gcsBucket: 'mock-inso-assistant-datasets',
        gcsPaths: ['gs://mock-inso-assistant-datasets/datasets/mock/dataset/default/train/file1.parquet'],
        save: vi.fn(),
      };
