    ...
    const worker = new Worker(new WorkerOptions({
      agent: async (ctx) => {
        ...
        const initialContext = new llm.ChatContext().append({
          ...
          text: 'You are Alti Assistant, a highly intelligent and helpful voice assistant. Keep your answers concise, conversational, and directly address the user.',
        });
        ...
        const greeting = 'Hello! I am Alti Assistant. How can I help you today?';
