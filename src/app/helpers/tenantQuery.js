 ...
 */
export const validateTenantOwnership = (req, document, documentType = 'Resource') => {
  if (!req || !req.tenantId) {
 ...
 */
export const validateBulkTenantOwnership = (req, documents, documentType = 'Resources') => {
  if (!req || !req.tenantId) {
  ...
  documents.forEach((doc, index) => {
    if (!doc.tenantId) {
      logger.warn(`${documentType}[${index}] does not have tenantId field:`, doc._id);
      return;
    }
