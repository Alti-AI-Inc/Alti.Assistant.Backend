...
| **Inso Assistants EV Sedan (2025)**| **Battery Management Module**| **NHTSA #25V-045** | **12,000 Units Affected** | Physical Inspection & Swap |`;
...
export const HrsaHealthCentersProvider = {
  ...
  mandatoryRule: '▸ Highlight health clinic titles, FQHC federal charters, and federal funding allocations in **BOLD** (e.g. **Inso Assistants Health Center**, **FQHC Certified**, **$1,245,000 Federal Grant**)',
...
|---------------------------------|---------------------------|------------------------------|-------------------------------|------------------------------|
| **Inso Assistants Community Health (MI)** | **FQHC Certified** | **24,500 Active Patients** | Primary Care & Dental Services| **$1,245,000 Federal Grant** |
...
| **Vance Medical Hub (Ann Arbor)**| Look-Alike Qualified | 3,450 Active Patients | Family Practice Medicine | FQHC Service Rebates Only |`;
    ...
    const metadata = {
      ...
      clinicName: 'Inso Assistants Community Health (MI)',
...
export const UsdaFarmersMarketsProvider = {
  ...
  mandatoryRule: '▸ Present farmers market names, payment options, and locations in **BOLD** (e.g. **Inso Assistants Farmers Market**, **SNAP/EBT Accepted**, **Ann Arbor Downtown**)',
...
|--------------------------|----------------------------|-------------------------------|---------------------------|-----------------------|
| **Inso Assistants Farmers Market** | **Ann Arbor Downtown (MI)**| **SNAP/EBT Accepted** | May 01 - October 31 | Verified - Active |
...
| **Vance Organic Market** | Ann Arbor West Sector | WIC Coupons Accepted | June 01 - September 30 | Verified - Active |`;
    ...
    const metadata = {
      ...
      marketName: 'Inso Assistants Farmers Market',
