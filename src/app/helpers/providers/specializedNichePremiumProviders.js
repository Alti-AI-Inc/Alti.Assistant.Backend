...
|------------------|-----------------|-------------------|-------------------|------------------|--------------------|
| **insoapp / Inso.Assistant** | **PR #452** | **feat: Stage 9 integrations** (Approved) | **Issue #118**: Fix citations dedup | **v1.2.0 Release** | **@hyper-dev** |
| **google / gemma.cpp** | **PR #82** | **fix: memory alignment** (Pending) | **Issue #39**: ARM build error | **v2.1.0 Release** | **@gemma-core** |`;
    ...
    const metadata = {
      ...
      repoScope: 'insoapp/Inso.Assistant',
      prId: 'PR #452',
      issueId: 'Issue #118',
