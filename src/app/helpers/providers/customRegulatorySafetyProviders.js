...
export const DolEbsaProvider = {
  ...
  mandatoryRule: '▸ Highlight company names, Form 5500 plan sizes, and fiduciary ratings in **BOLD** (e.g. **Inso AI Tech 401(k)**, **$420,000,000**, **Fiduciary Grade A**)',
...
|------------------------------|-------------------|--------------------------|--------------------------------|----------------------------|
| **Inso AI Tech 401(k) Plan** | **5500-2026-9042** | **$420,000,000** | **12,450 Participants** | **Fiduciary Grade A (Clean)**|
...
| **Pinnacle Wealth Retirement**| **5500-2025-0811** | **$95,000,000** | **1,950 Participants** | **Fiduciary Grade B (Minor)**|`;
    ...
    const metadata = {
      domain: 'dol_ebsa',
      planName: 'Inso AI Tech 401(k) Plan',
...
| **Inso AI Employees Credit** | **Charter #31204** | **12.45% Net Worth** | **$450 Million** | **WELL CAPITALIZED** |`;
