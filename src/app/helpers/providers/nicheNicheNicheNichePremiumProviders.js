...
|------------------------|-------------------|-------------|------------------------|-------------------|----------------|
| **hyperdev/insoapp** | **insoapp/insoapp** | **1,420 forks** | **2026-05-24** | **Active Fork** | #f1e05a |
| **testuser/insoapp** | **insoapp/insoapp** | **1,420 forks** | **2026-05-23** | **Active Fork** | #563d7c |`;

    const metadata = {
      domain: 'github_forks',
      parentRepo: 'insoapp/insoapp',
      forksCount: 1420,
      forkedRepoPath: 'hyperdev/insoapp'
    };
