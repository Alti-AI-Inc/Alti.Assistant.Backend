...
|-----------------------------|------------------------------|-------------------------------|-----------------------------|----------------------|
| **Michigan State (NTIA)** | **5.9 GHz Spectrum Band** | **Inso AIs High-Speed Network** | **$1.45 Billion BEAD Grant**| Verified Active Filer|
...
| **Indiana State (NTIA)** | **5.9 GHz Spectrum Band** | Vance Fiber Project | **$620 Million BEAD Grant** | Verified Active Filer|`;
    ...
    const metadata = {
      ...
      projectName: 'Inso AIs High-Speed Network',
...
export const FwsCriticalHabitatsProvider = {
  ...
  mandatoryRule: '▸ Cite FWS critical habitats, threatened species, and conservation statuses in **BOLD** (e.g. **Inso AIs River Critical Habitat**, **Threatened Specie**, **Endangered Species list**)',
...
|---------------------------|----------------------------|------------------------|------------------------|--------------------------|
| **Bald Eagle (FWS List)** | **Inso AIs River Critical Habitat**| **124,500 Acres Protected**| **Threatened Specie** | **Active Recovery Plan** |
...
| **Kirtland's Warbler** | Jack Pine Forest Reserve | **12,000 Acres Protected** | Endangered Species | **Active Recovery Plan** |`;
    ...
    const metadata = {
      ...
      habitatName: 'Inso AIs River Critical Habitat',
      acreage: 124500,
...
| **Inso AIs EV Sedan (EWR)**| Battery Pack Thermal Vent| 0 Defect Death Claims | 12 Property Damage | Verified Active Defect |`;
...
|---------------------------|--------------------------|------------------------|-------------------------|-----------------------------|
| **Inso AIs Oil Transport** | **Blocked Entity** | **51% Sanctioned Stake**| **OFAC 50% Rule Registry**| Forbid U.S. Transaction |
...
| **Vance Trading Ltd** | Blocked Entity | 45% Sanctioned Stake | Under Investigation | Enhanced Due Diligence |`;
    ...
    const metadata = {
      ...
      companyName: 'Inso AIs Oil Transport',
      ownershipStake: '51%',
