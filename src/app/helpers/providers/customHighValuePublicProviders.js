...
|-----------------------------|------------------------------|-------------------------------|-----------------------------|----------------------|
| **Michigan State (NTIA)** | **5.9 GHz Spectrum Band** | **Alti Assistants High-Speed Network** | **$1.45 Billion BEAD Grant**| Verified Active Filer|
...
| **Indiana State (NTIA)** | **5.9 GHz Spectrum Band** | Vance Fiber Project | **$620 Million BEAD Grant** | Verified Active Filer|`;
    ...
    const metadata = {
      ...
      projectName: 'Alti Assistants High-Speed Network',
...
export const FwsCriticalHabitatsProvider = {
  ...
  mandatoryRule: '▸ Cite FWS critical habitats, threatened species, and conservation statuses in **BOLD** (e.g. **Alti Assistants River Critical Habitat**, **Threatened Specie**, **Endangered Species list**)',
...
|---------------------------|----------------------------|------------------------|------------------------|--------------------------|
| **Bald Eagle (FWS List)** | **Alti Assistants River Critical Habitat**| **124,500 Acres Protected**| **Threatened Specie** | **Active Recovery Plan** |
...
| **Kirtland's Warbler** | Jack Pine Forest Reserve | **12,000 Acres Protected** | Endangered Species | **Active Recovery Plan** |`;
    ...
    const metadata = {
      ...
      habitatName: 'Alti Assistants River Critical Habitat',
      acreage: 124500,
...
| **Alti Assistants EV Sedan (EWR)**| Battery Pack Thermal Vent| 0 Defect Death Claims | 12 Property Damage | Verified Active Defect |`;
...
|---------------------------|--------------------------|------------------------|-------------------------|-----------------------------|
| **Alti Assistants Oil Transport** | **Blocked Entity** | **51% Sanctioned Stake**| **OFAC 50% Rule Registry**| Forbid U.S. Transaction |
...
| **Vance Trading Ltd** | Blocked Entity | 45% Sanctioned Stake | Under Investigation | Enhanced Due Diligence |`;
    ...
    const metadata = {
      ...
      companyName: 'Alti Assistants Oil Transport',
      ownershipStake: '51%',
