...
const gcpKeyPath = path.join(__dirname, '../insoai_gcp.json');
...
const keyPaths = [
  {
    name: 'insoai-vm-key.pub',
    path: path.join(__dirname, '../../insoai-vm-key.pub'),
  },
  {
    name: 'insoai_deploy_key.pub',
    path: path.join(__dirname, '../../insoai_deploy_key.pub'),
  },
  {
    name: 'insoai_backend_key.pub',
    path: path.join(__dirname, '../../insoai_backend_key.pub'),
  },
];
...
async function main() {
  ...
  const username = process.env.VM_USER || 'insoai_deployer';
