...
knowledgeQueryService.semanticSearch = async (query, ownerType, ownerId, options = {}) => {
  ...
  return {
    ...
    results: [
      {
        fileName: 'inso_internal_strategy_2026.pdf',
        content: `Inso.Assistant internal system specifications define the Deep Research module as an autonomous Perplexity-killer. It leverages pgvector RAG with Reciprocal Rank Fusion (RRF) for local search and Gemini search grounding for real-time web scans.`,
        similarity: 0.92,
        gcsUrl: 'https://storage.googleapis.com/inso_assistant_datasets/inso_internal_strategy_2026.pdf'
      }
    ],
    totalResults: 1,
    query
