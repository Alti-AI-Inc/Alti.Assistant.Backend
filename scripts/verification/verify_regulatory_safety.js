 ...
 *
 * Verification script for testing Inso Assistant's Stage 43 Premium Regulatory, Corporate Benefit,
...
async function runVerification() {
  ...
  const testQueries = [
    ...
    },
    {
      ...
      query: 'Retrieve dol ebsa form 5500 retirement assets for Inso Assistants Tech 401k plan',
      expectedId: 'dol_ebsa'
    },
    {
