 ...
 *
 * Verification script for testing Inso Assistant's Stage 46 Premium Scientific Research,
  ...
  const testQueries = [
    {
      ...
      query: 'Check solar installation capacity and photovoltaic PV data project registry for Inso Assistants Solar Array',
    ...
    },
    {
      ...
      query: 'Retrieve ocean freight forwarder nvocc registry FMC shipping license for Inso Assistants Shipping Forwarder',
