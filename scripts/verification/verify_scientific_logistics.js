 ...
 *
 * Verification script for testing Alti Assistant's Stage 46 Premium Scientific Research,
  ...
  const testQueries = [
    {
      ...
      query: 'Check solar installation capacity and photovoltaic PV data project registry for Alti Assistants Solar Array',
    ...
    },
    {
      ...
      query: 'Retrieve ocean freight forwarder nvocc registry FMC shipping license for Alti Assistants Shipping Forwarder',
