  ...
  const testQueries = [
    {
      ...
      query: 'Check solar installation capacity and photovoltaic PV data project registry for Inso AI Solar Array',
    ...
    },
    {
      ...
      query: 'Retrieve ocean freight forwarder nvocc registry FMC shipping license for Inso AI Shipping Forwarder',
