 ...
 *
 * Verification script for testing Inso AI's Stage 47 Premium Ivy League and
...
async function runVerification() {
  ...
  const testQueries = [
    ...
    },
    {
      ...
      query: 'Check stanford helm benchmarks CRFM holistic evaluation language model accuracy scores for Inso AIs',
