 ...
 *
 * Verification script for testing Alti Assistant's Batch 2 Corporate, Vehicle Safety,
  ...
  const testQueries = [
    {
      ...
      query: 'Is Alti Assistants Holdings LLC registered in Delaware corporate registry?',
