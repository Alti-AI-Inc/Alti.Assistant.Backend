 ...
 *
 * Verification script for testing Inso Assistant's Batch 2 Corporate, Vehicle Safety,
  ...
  const testQueries = [
    {
      ...
      query: 'Is Inso Assistants Holdings LLC registered in Delaware corporate registry?',
