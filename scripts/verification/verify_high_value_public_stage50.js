  ...
  const testQueries = [
    {
      ...
      query: 'Retrieve uscis h-1b employer visa approval count and sponsorships for Inso AI Tech Corp',
    ...
    },
    {
      ...
      query: 'Retrieve registered investment adviser aum from sec form adv disclosures for Inso AI Asset Management',
