 ...
 *
 * Verification script for testing Inso AI's Stage 50 Premium High-Value Public Grounding Channels.
 */
  ...
  const testQueries = [
    {
      ...
      query: 'Retrieve uscis h-1b employer visa approval count and sponsorships for Inso AIs Tech Corp',
    ...
    },
    {
      ...
      query: 'Retrieve registered investment adviser aum from sec form adv disclosures for Inso AIs Asset Management',
